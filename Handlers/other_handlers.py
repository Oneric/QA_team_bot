...
async def deach(message: Message, bot: Bot):
    await bot.send_message(LEXICON_CHAT_ID['OFFICE_TOMSK'],
                       LEXICON_TIME['time'],
                       LEXICON_MAIN_THREADS['General']
                       )
...
async def deach(message: Message, bot: Bot):
    await bot.send_message(LEXICON_CHAT_ID['QA_TEAM'],
                       LEXICON_TIME['test'],
                       LEXICON_QA_THREADS['Флудильня']
                       )